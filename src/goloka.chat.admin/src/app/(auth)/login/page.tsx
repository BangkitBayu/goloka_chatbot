  ...
  return (
    <div style={{ display: "flex", width: "100%", minHeight: "100vh" }}>
      ...
      <div
        style={{
          flex: "0 0 42%",
          background: "linear-gradient(160deg, #0A0A0A 0%, #1A1A00 60%, #0A0A0A 100%)",
          display: "flex",
      ...
      >
        ...
        {/* Center content */}
        <div>
          <p style={{ fontSize: 12, fontWeight: 700, color: "#CA8A04", letterSpacing: "0.12em", marginBottom: 12 }}>
            WELCOME BACK
          </p>
          <h1 style={{ fontSize: 38, fontWeight: 900, color: "#EAEAEA", lineHeight: 1.15, marginBottom: 20 }}>
            Blast smarter,<br />not harder.
          </h1>
          <p style={{ fontSize: 14, color: "#71717A", lineHeight: 1.7, marginBottom: 36 }}>
            GOLOKA powers your WhatsApp marketing at scale. Reach thousands of customers with a few clicks.
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <a href="#" style={{ fontSize: 12, color: "var(--accent-dark)", textDecoration: "none", fontWeight: 500 }}>
                  Forgot password?
                </a>
              </div>
              <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <input type="checkbox" id="remember" style={{ width: 15, height: 15, accentColor: "#FACC15" }} />
            ...
            <Link href="/dashboard">
              <button
                ...
                style={{ width: "100%", justifyContent: "center", fontSize: 15, padding: "13px 20px", marginTop: 4 }}
              >
